...
fbase="/home/pablo/Desktop/MADnaLAB/examples/test"
fscripts="/home/pablo/Desktop/MADnaLAB/examples/test/scripts_benchmark"
imin=1000
...
set title "$title (nm)"
set term png
set output "$fbase/Simulations/Comparison/scatter_plot_${xxx}.png"
p "$fbase/Simulations/Comparison/$xxx" u 4:6:5:7 t '' w xye pt 7 ps 2 lw 2, x t '' lw 2
daqui
done
...
set term png
set output "$fbase/Simulations/Comparison/scatter_plot_${xxx}.png"
p "$fbase/Simulations/Comparison/$xxx" u 5:7:6:8 t '' w xye pt 7 ps 2 lw 2, x t '' lw 2
daqui
...
set term png
set output "$fbase/Simulations/Comparison/scatter_plot_${xxx}.png"
p "$fbase/Simulations/Comparison/$xxx" u 2:4:3:5 t '' w xye pt 7 ps 2 lw 2, x t '' lw 2
daqui
done
